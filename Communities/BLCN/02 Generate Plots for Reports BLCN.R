...
# Title:   Generate Plots for 2026 BLCN Camera Data Report
# Date:    March 2026
...
# Load data
load(paste0(g_drive_cbme, "BLCN/Data/BLCN Data Objects.RData"))
...
location_ranges <- df_od |>
  ...
  mutate(analysis = ifelse(str_detect(project, "Winefred"), "Winefred Lake", "BLCN"))
...
# Going to only present results from the BLCN cameras
